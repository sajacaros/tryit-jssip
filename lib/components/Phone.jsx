...
function defineVideoConstraints({ resolution, framerateMin, framerateMax, videoinputkey }) {
  ...
  logger.debug('video constraints : ', videoConstraints);
  return videoConstraints;
}

function defineAudioConstraints({ audioinputkey }) {
  let audioConstraints = {}
  audioConstraints = defineDeviceInput(audioConstraints, audioinputkey);
  logger.debug('audio constraints : ', audioConstraints);
...
export default class Phone extends React.Component {
  ...
  componentDidMount() {
    ...
    this._ua.on('newRTCSession', (data) => {
      ...
      session.on('peerconnection', pc => logger.debug('413 peerconnection : ', pc));
    });
